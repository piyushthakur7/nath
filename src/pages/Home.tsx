            ...
            >
              ...
              <div className="flex flex-col items-center gap-12">
                <p className="text-xl md:text-2xl font-serif italic text-ink/70 max-w-2xl leading-relaxed">
                  "Nath Enterprise: Bridging nature's raw power with <br className="hidden md:block"/> high-end industrial engineering."
                </p>
                <Link 
                  to="/products"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24 gap-12">
            <div className="max-w-2xl">
              <h3 className="text-3xl md:text-5xl font-serif italic mb-8 premium-gradient-text tracking-wide">Nath Enterprise</h3>
